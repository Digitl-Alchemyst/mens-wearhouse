  ...
  return (
    <main className='mb-8 mt-8 flex w-full max-w-[1600px] flex-col items-center justify-center'>
      ...
      <section className='flex flex-col items-center justify-start'>
        <h1 className='mb-5 w-full max-w-[1400px] py-4 text-2xl text-mwblack-800'>
          Best Selling Suits
        </h1>
        ...
        <h1 className='mb-5 w-full max-w-[1400px] py-4 text-4xl text-mwblack-800'>
          Brands We Love
        </h1>
        ...
        <h1 className='mb-5 mt-8 w-full max-w-[1400px] py-4 text-4xl text-mwblack-800'>
